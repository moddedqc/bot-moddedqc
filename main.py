...
import os       #biblioteke discord.py
...
@bot.command()
	async def infodiscord(ctx):                                   #command pour avoir les infos serveur discord
		...
		message = f"le serveur **{serveurName}** contient *{numberUtilisateur}*. /n la description du serveur est {serveurDescription} et possede *{numberChannelVocaux}* channels vocaux et *{numberOfTextChannels}*channels textuel"
